...
import { Checkbox, CheckboxGroup, CheckboxIcon, Tooltip, useCheckbox } from '@chakra-ui/react'
...
export const OffProgressBar: React.FC<OffProgressBarProps> = ({ children, steps }) => {
    ...
    const { getCheckboxProps, getLabelProps, htmlProps } = useCheckbox()
    return (
        <Box
            bgColor={'red.400'}
            zIndex={4}
                ...
                <CheckboxGroup >
                    ...
                    {stepsState.map(ss =>
                        ...
                        >
                            ...
                            >
                                <Icon  {...getLabelProps()} ><BiChevronDownCircle size={36} /></Icon>
                            </Checkbox>
                        </Tooltip>
                    )}
                </CheckboxGroup>
